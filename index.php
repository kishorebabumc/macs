<?php
      ...
      if($count == 1) {  
         ...
         if($row['userstatus']==1){ 
            if($row['roleid'] == 1) {
                ...
                header("location: employees/employee.php");	     
            }            
			else {
             ...
             $error = "Member/Employee Terminated/Suspended/Hold from Services";
         } 
       }
      else {
  ...
  $name = $connection->query("SELECT * FROM master");
...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title><?php echo $name['name'].", ".$name['address']; ?></title>
					...
					<div class="col-sm-10 col-sm-offset-1">
						<div class="login-container">
							<div class="center">
								...
								<h4 class="blue" id="id-company-text">&copy; <?php echo $name['name'].", ".$name['address']; ?>
</h4>
							</div>
